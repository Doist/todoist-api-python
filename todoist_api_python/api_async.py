...
class TodoistAPIAsync:
    ...
    async def get_reminders(
        ...
        *,
        task_id: str | None = None,
        limit: Annotated[int, Ge(1), Le(200)] | None = None,
    ) -> AsyncIterator[list[Reminder]]:
        """
        Get an async iterable of lists of reminders.

        The response is an async iterable of lists of reminders.
        Be aware that each iteration fires off a network request to the Todoist API,
        and may result in rate limiting or other API restrictions.
    ...
    async def get_location_reminders(
        self,
        *,
        task_id: str | None = None,
        limit: Annotated[int, Ge(1), Le(200)] | None = None,
    ) -> AsyncIterator[list[LocationReminder]]:
        """
        Get an async iterable of lists of location reminders.

        The response is an async iterable of lists of location reminders.
        Be aware that each iteration fires off a network request to the Todoist API,
        and may result in rate limiting or other API restrictions.
    ...
    async def delete_location_reminder(self, location_reminder_id: str) -> bool:
        """
